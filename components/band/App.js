...
function Band({ maxSpeed = 50, minSpeed = 10 }) {
  ...
  const [curve] = useState(() => new THREE.CatmullRomCurve3([new THREE.Vector3(-2, 0, 0), new THREE.Vector3(-1, 0, 0), new THREE.Vector3(0, 0, 0), new THREE.Vector3(1, 0, 0)])); // Ajustando a curva
